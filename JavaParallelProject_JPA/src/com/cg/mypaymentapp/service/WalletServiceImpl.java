...
public class WalletServiceImpl implements WalletService {
	...
	public Customer fundTransfer(String sourceMobileNo, String destinationMobileNo, BigDecimal amount) {
		...
		if (sourceCustomer != null && destinationCustomer != null) {
			...
			if (sourceBalance.getBalance().compareTo(amount) > 0) {
				...
				Transaction sourceTransaction = new Transaction(sourceMobileNo, transactionType1, amount, date);
				Transaction destinationTransaction = new Transaction(destinationMobileNo, transactionType2, amount,
						date);
	...
	public ArrayList<Transaction> recentTransactions(String mobileno) {
		ArrayList<Transaction> transaction = repo.recentTransactions(mobileno);
		return transaction;
	}
}